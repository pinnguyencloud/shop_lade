...
-- 6. Tạo bảng warehouse_import_details
...
-- 8. Thêm dữ liệu mẫu cho categories
...
-- 10. Thêm dữ liệu mẫu cho suppliers
INSERT INTO suppliers (supplier_name, address, phone, email, tax_number, cooperation_day, note) 
VALUES 
('Công Ty TNHH ABC', '123 Đường Lớn, Quận 1, TP.HCM', '0123456789', 'contact@abc.vn', '1234567890', '2022-01-01', 'Cung cấp linh kiện điện tử'),
('Công Ty TNHH XYZ', '456 Đường Nhỏ, Quận 3, TP.HCM', '0987654321', 'support@xyz.vn', '0987654321', '2023-05-15', 'Chuyên phân phối hàng tiêu dùng');
